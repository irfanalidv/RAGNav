    ...
    messages = [
        {
            "ts": "1.0",
            "user": "alice",
            "text": "We should rotate the Mistral key.",
            "thread_ts": "1.0",
        },
        {
            "ts": "2.0",
            "user": "bob",
            "text": "Agree. Also add .env to .gitignore.",
            "thread_ts": "1.0",
        },
        {
            "ts": "3.0",
            "user": "alice",
            "text": "Done. What's next for observability?",
            "thread_ts": "1.0",
        },
        {
            "ts": "4.0",
            "user": "carol",
            "text": "Add timing traces + retrieval cache.",
            "thread_ts": "1.0",
        },
    ]
